...
export function generateMetadata() {
  return {
    title: 'تماس با ما',
    description: 'برای استعلام قیمت، رزرو بازدید از شعبه، یا مشاوره‌ی پیش از خرید.',
  };
}
...
export default async function ContactPage() {
  ...
  const lead =
    contact?.address ??
    'برای استعلام قیمت، رزرو بازدید از شعبه، یا مشاوره‌ی پیش از خرید. تیم ما آماده‌ی پاسخ‌گویی است.';
