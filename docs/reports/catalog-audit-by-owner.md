...
- [ ] **Hub #29 (آیرون)** — `introBody` is placeholder scaffolding
**ورنا (verna)**
- [ ] **SEO meta title + description** — all 7.
- [ ] **Hub designs/40 (ورنا)** — near-empty shell: description, tagline, hubIntro,
**پارلا (parla)**
- [ ] **SEO meta title + description** — all 19.
- [ ] **Hub designs/36 (پارلا)** — has hero/slider/logo + 3 occupancyMedia, but
**لوف (loof)**
- [ ] SEO meta title/description · editorial copy · materials — all 17 (materials blocked on missing records).
- [ ] **Hub designs/31** — empty copy (tagline/description/hubIntro/intro/story), null alt on all
**کارولین (caroline)**
- [ ] SEO meta title/description · editorial copy · materials — all 16 (materials blocked on missing records).
- [ ] **Hub designs/24** — empty editorial (description/tagline/hubIntro/intro/story/materialCallouts/designDetails);
**الیزابت (elizabeth)**
